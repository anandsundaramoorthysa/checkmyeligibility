...
CheckMyEligibility is intentionally built around two **swap seams**, so today's mock implementation
...
CheckMyEligibility is a standard Next.js app — statically-rendered marketing pages plus a dynamic
`/api/chat` route.
