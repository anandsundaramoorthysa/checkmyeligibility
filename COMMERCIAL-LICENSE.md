...
- Running it in a **paid or revenue-generating** offering (subscriptions, ads, fees, etc.).
- **Internal use within a for-profit company's** operations.
- Bundling, hosting, or reselling it as part of a commercial solution.

The following remain **free** under the PolyForm Noncommercial License (no commercial license
needed):

- Personal projects, study, experiments, and hobby use.
- **Research and educational** use.
- Use by **charitable organizations** and **government institutions**.

> If you're unsure whether your use is commercial, please ask — we're happy to clarify.
...
recommend the right license tier.
