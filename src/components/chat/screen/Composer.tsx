...
export const Composer = forwardRef<HTMLTextAreaElement, Props>(function Composer(
  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      <form
        onSubmit={submit}
        className="flex flex-col gap-2 rounded-2xl border border-navy/15 bg-surface-card px-3 py-2 shadow-card-lg transition-shadow focus-within:border-navy/30 dark:border-white/15 dark:bg-navy-dark dark:focus-within:border-white/30"
      >
        ...
        <textarea
          ...
          aria-label="Message"
          className="block w-full resize-none border-0 bg-transparent px-1 py-1 text-sm leading-relaxed text-ink outline-none placeholder:text-ink-faint scrollbar-thin dark:text-white dark:placeholder:text-white/40"
        ...
        <div className="flex items-center gap-1">
          <div className="relative shrink-0">
            <button
              ...
              className="flex h-9 items-center gap-1 rounded-full border border-navy/15 px-2 text-ink-muted transition-colors hover:bg-surface-subtle hover:text-navy dark:border-white/15 dark:text-white/70 dark:hover:bg-white/10 dark:hover:text-white"
            >
            ...
            {langOpen && (
              <>
                <div
                  ...
                  aria-hidden="true"
                />
                <div className="absolute bottom-11 left-0 z-40 w-36 animate-fade-in rounded-2xl border border-navy/10 bg-surface-card p-1.5 shadow-card-lg dark:border-white/10 dark:bg-navy-dark">
                  {LANGUAGES.map((l) => (
                    <button
                      key={l.code}
                      type="button"
                      ...
                      className={cn(
                        "block w-full rounded-lg px-2.5 py-1.5 text-left text-sm transition-colors hover:bg-surface-subtle dark:hover:bg-white/10",
                        l.code === lang
              ...
              <button
                ...
                className={cn(
                  ...
                  listening
                    ...
                    : "text-ink-muted hover:bg-surface-subtle hover:text-navy dark:text-white/70 dark:hover:bg-white/10 dark:hover:text-white",
                )}
              >
                {listening ? (
          ...
          {pending ? (
            <button
              ...
              onClick={onStop}
              aria-label="Stop"
              className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-navy/15 text-ink-muted transition-transform active:scale-90 dark:border-white/15 dark:text-white/70"
            >
