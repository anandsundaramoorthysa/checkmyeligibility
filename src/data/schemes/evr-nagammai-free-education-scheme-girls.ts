...
export const evrNagammaiFreeEducationSchemeGirls: Scheme = {
  ...
  summary:
    "State welfare scheme for economically weaker girls in Tamil Nadu providing free education and financial support at various educational levels from primary.",
  description:
