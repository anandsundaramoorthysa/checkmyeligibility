...
export const readersAllowanceToVisuallyImpairedPersons: Scheme =   {
    ...
    shortName: "RATVIP",
    summary:
      "Annual readers allowance of ₹3,000–₹6,000 for visually impaired students to hire personal readers, covering Class 9 through postgraduate and professional.",
    description:
