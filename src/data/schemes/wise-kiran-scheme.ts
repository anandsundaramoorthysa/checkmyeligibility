...
export const wiseKiranScheme: Scheme = {
  id: "wise-kiran-scheme",
  slug: "wise-kiran-scheme",
  name: "Women in Science and Engineering-KIRAN (WISE-KIRAN)",
  shortName: "WISE-KIRAN",
  summary:
    "An umbrella scheme of DST providing research fellowships, post-doctoral support, and career re-entry opportunities for women in STEM across multiple.",
  description:
