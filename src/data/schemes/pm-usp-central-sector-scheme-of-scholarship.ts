...
export const pmUspCentralSectorSchemeOfScholarship: Scheme = {
  id: "pradhan-mantri-uchchatar-shiksha-protsahan-pm-usp-csss",
  ...
  summary:
    "Up to 82,000 fresh scholarships per year for meritorious students from families with income up to ₹4.5 lakh — ₹12,000/year at graduation, ₹20,000/year at.",
  description:
