...
export const nationalMeansCumMeritScholarshipScheme: Scheme = {
  ...
  shortName: "NMMS",
  summary: "₹12,000 per year for Class IX and X students in government schools from families with annual income up to ₹3,50,000, selected through a state-level.",
