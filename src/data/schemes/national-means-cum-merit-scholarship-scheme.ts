...
export const nationalMeansCumMeritScholarshipScheme: Scheme = {
  ...
  shortName: "NMMS",
  summary: "₹12,000 per year for Class IX and X students in government schools from families with annual income up to ₹3,50,000, selected through a state-level entrance exam to reduce school dropouts and support secondary education continuation.",
  ...
  benefits: [
    ...
    "Scholarship continues for both Class IX and Class X provided the student maintains minimum marks annually",
    "SC/ST students get relaxed marks criterion (50% instead of 55%)",
    "No employment bond or repayment obligation",
  ],
  requiredDocuments: [
    {
