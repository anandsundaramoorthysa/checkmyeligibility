...
export const prematricScholarshipUncleanOccupation: Scheme = {
  ...
  summary: "A central government scholarship program supporting students from economically disadvantaged families whose parents are engaged in occupations classified.",
