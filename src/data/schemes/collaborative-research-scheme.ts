...
export const collaborativeResearchScheme: Scheme = {
  ...
  shortName: "CRS",
  summary: "Central government research funding (₹10 lakh to ₹3 crore per project) supporting collaborative STEM research between academic institutions, government.",
